...
gameWebSocket.onCreateGame = (msg) => {
  let text = "Game created with ID: " + msg.data;
  addToChat(text);
};
gameWebSocket.onMessageGame = (msg) => {
  addToChat(msg.playerId + " sent: " + msg.data);
};
gameWebSocket.onOtherJoinGame = (msg) => {
  addToChat(msg.playerId + " joined the game.");
};
gameWebSocket.onOtherLeaveGame = (msg) => {
  addToChat(msg.playerId + " left the game.");
};
